  ...
  [[maybe_unused]] autoware_planning_msgs::msg::StopReason * stop_reason)
{
  ...
  [[maybe_unused]] const double max_range =
    occ_grid_ptr->info.width * occ_grid_ptr->info.resolution;
  ...
  occlusion_spot_utils::filterPossibleCollisionByRoadType(
    lanelet_map_ptr, offset_from_start_to_ego, *path, possible_collisions, PRIVATE, param_);
