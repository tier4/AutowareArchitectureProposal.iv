...
std::pair<int, double> findWayPointAndDistance(
  const autoware_planning_msgs::msg::PathWithLaneId & path, const geometry_msgs::msg::Pose & p)
{
...
double calcArcLengthFromWayPoint(
  const autoware_planning_msgs::msg::PathWithLaneId & path, const int & src, const int & dst)
{
  double length = 0;
...
double calcSignedArcLength(
  const autoware_planning_msgs::msg::PathWithLaneId & path, const geometry_msgs::msg::Pose & p1,
...
double calcSignedDistance(const geometry_msgs::msg::Pose & p1, const geometry_msgs::msg::Pose & p2)
{
