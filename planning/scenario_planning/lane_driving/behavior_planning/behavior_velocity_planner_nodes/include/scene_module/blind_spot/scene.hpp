...
private:
  ...
  struct DebugData
  {
    ...
    autoware_auto_msgs::msg::PathWithLaneId spline_path;
...
//   */
   ...
   */
  bool isTargetObjectType(const autoware_auto_msgs::msg::PredictedObject & object) const;
...
//   */
  ...
  int insertPoint(
    ...
    autoware_auto_msgs::msg::PathWithLaneId * path) const;
