...
int insertPoint(
  ...
  autoware_auto_msgs::msg::PathWithLaneId * inout_path)
{
...
bool splineInterpolate(
  const autoware_auto_msgs::msg::PathWithLaneId & input, const double interval,
  autoware_auto_msgs::msg::PathWithLaneId * output, const rclcpp::Logger logger)
{
  *output = input;
  ...
  for (size_t i = 0; i < resampled_s.size(); i++) {
    autoware_auto_msgs::msg::PathPointWithLaneId p;
...
bool setVelocityFrom(
  const size_t idx, const double vel, autoware_auto_msgs::msg::PathWithLaneId * input)
{
...
bool generateStopLine(
  ...
  autoware_auto_msgs::msg::PathWithLaneId * original_path,
  const autoware_auto_msgs::msg::PathWithLaneId & target_path, int * stop_line_idx,
