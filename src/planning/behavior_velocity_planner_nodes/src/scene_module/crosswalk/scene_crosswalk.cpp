  ...
  autoware_auto_msgs::msg::PathWithLaneId * path)
{
  ...
  if (state_ == State::APPROACH) {
    ...
    autoware_auto_msgs::msg::PathWithLaneId slow_path, stop_path;
...
bool CrosswalkModule::checkStopArea(
  const autoware_auto_msgs::msg::PathWithLaneId & input, const Polygon & crosswalk_polygon,
  const autoware_auto_msgs::msg::PredictedObjects::ConstSharedPtr & objects_ptr,
  [[maybe_unused]] const sensor_msgs::msg::PointCloud2::ConstSharedPtr & no_ground_pointcloud_ptr,
  autoware_auto_msgs::msg::PathWithLaneId & output, bool * insert_stop)
{
  output = input;
  *insert_stop = false;
...
bool CrosswalkModule::checkSlowArea(
  ...
  const autoware_auto_msgs::msg::PredictedObjects::ConstSharedPtr & objects_ptr,
  [[maybe_unused]] const sensor_msgs::msg::PointCloud2::ConstSharedPtr & no_ground_pointcloud_ptr,
  autoware_auto_msgs::msg::PathWithLaneId & output)
{
  output = input;
  bool pedestrian_found = false;
  const bool external_slowdown =
