...
private:
  ...
  {
    bool stop_required;
    autoware_auto_msgs::msg::PathWithLaneId path_raw;
    ...
    autoware_auto_msgs::msg::PredictedObjects conflicting_targets;
    autoware_auto_msgs::msg::PredictedObjects stuck_targets;
  };
...
//   */
   ...
   */
  autoware_auto_msgs::msg::PathWithLaneId trimPathWithLaneId(
    const autoware_auto_msgs::msg::PathWithLaneId & path);
   ...
   * @return true if the object has a target type
   */
  bool isTargetStuckVehicleType(const autoware_auto_msgs::msg::PredictedObject & object) const;
   ...
   */
  Polygon2d toFootprintPolygon(const autoware_auto_msgs::msg::PredictedObject & object) const;
