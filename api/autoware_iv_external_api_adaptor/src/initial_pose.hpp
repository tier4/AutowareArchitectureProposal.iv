...
private:
  ...
  autoware_api_utils::Service<InitializePose>::SharedPtr srv_set_initialize_pose;
  autoware_api_utils::Service<InitializePoseAuto>::SharedPtr srv_set_initialize_pose_auto;
  autoware_api_utils::Client<PoseWithCovarianceStamped>::SharedPtr cli_set_initialize_pose;
  autoware_api_utils::Client<InitializePoseAuto>::SharedPtr cli_set_initialize_pose_auto;
