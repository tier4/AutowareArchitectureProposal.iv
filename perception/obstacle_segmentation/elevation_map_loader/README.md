...
| pcl_grid_map_extraction/grid_map/height_type             | int   | The parameter that determine the representative point of a cell `0: Use the smallest value on z-axis` `1: Use the mean value of points in a cell` | 1             |
