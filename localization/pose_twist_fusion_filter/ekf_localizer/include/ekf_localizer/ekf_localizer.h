...
private:
  ...
  double
    pose_gate_dist_;      //!< @brief  the mahalanobis distance threshold to ignore pose measurement
  ...
  double
    twist_gate_dist_;  //!< @brief  measurement is ignored if the mahalanobis distance is larger than this value.
