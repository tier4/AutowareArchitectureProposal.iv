...
: rclcpp::Node(node_name, node_options)
{
  ...
  sub_twist_ = create_subscription<geometry_msgs::msg::TwistStamped>(
    "input/twist", 1, std::bind(&StopFilter::callbackTwistStamped, this, _1));
  sub_twist_with_covariance_ = create_subscription<geometry_msgs::msg::TwistWithCovarianceStamped>(
...
void StopFilter::callbackTwistStamped(const geometry_msgs::msg::TwistStamped::SharedPtr msg)
{
