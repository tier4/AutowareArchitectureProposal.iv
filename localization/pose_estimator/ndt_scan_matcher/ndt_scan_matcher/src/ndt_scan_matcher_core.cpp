  ...
  oscillation_threshold_(10)
{
  ...
  initial_pose_callback_group = this->create_callback_group(
  ...
  initial_pose_sub_ = this->create_subscription<geometry_msgs::msg::PoseWithCovarianceStamped>(
    ...
    std::bind(
      &NDTScanMatcher::callbackInitialPose, this,
      std::placeholders::_1), initial_pose_sub_opt);
  ...
  service_ = this->create_service<autoware_localization_srvs::srv::PoseWithCovarianceStamped>(
    "ndt_align_srv",
    std::bind(
      &NDTScanMatcher::serviceNDTAlign, this, std::placeholders::_1,
      std::placeholders::_2), rclcpp::ServicesQoS().get_rmw_qos_profile(), main_callback_group);
