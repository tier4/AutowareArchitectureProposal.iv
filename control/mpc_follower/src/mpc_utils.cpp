  ...
  std::string & frame_id)
{
  ...
  marker_poses.header.stamp = rclcpp::Time();
  ...
  // marker_text.type = visualization_msgs::msg::msg::Marker::TEXT_VIEW_FACING;
  // marker_text.action = visualization_msgs::msg::msg::Marker::ADD;
