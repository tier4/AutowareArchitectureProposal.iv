...
#ifndef SIMPLE_PLANNING_SIMULATOR__VEHICLE_MODEL__SIM_MODEL_DELAY_STEER_ACC_4WS_HPP_
#define SIMPLE_PLANNING_SIMULATOR__VEHICLE_MODEL__SIM_MODEL_DELAY_STEER_ACC_4WS_HPP_
...
public:
   ...
   */
  ~SimModelDelaySteerAcc4ws() = default;
...
private:
  ...
  std::deque<float64_t> f_steer_input_queue_;  //!< @brief buffer for steering command
  std::deque<float64_t> r_steer_input_queue_;  //!< @brief buffer for steering command
  ...
  const float64_t f_steer_delay_;              //!< @brief time delay for steering command [s]
  const float64_t f_steer_time_constant_;      //!< @brief time constant for steering dynamics
  const float64_t r_steer_delay_;              //!< @brief time delay for steering command [s]
  const float64_t r_steer_time_constant_;      //!< @brief time constant for steering dynamics
