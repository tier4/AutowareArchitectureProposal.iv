...
public:
  ...
  {
    empty_objects_pub_ = this->create_publisher<autoware_auto_perception_msgs::msg::TrackedObjects>(
      "~/output/objects", 1);
...
private:
  ...
  void timerCallback()
  {
    autoware_auto_perception_msgs::msg::TrackedObjects empty_objects;
