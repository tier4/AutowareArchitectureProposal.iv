...
private:
  ...
  rclcpp::Subscription<autoware_lanelet2_msgs::msg::MapBin>::SharedPtr sub_vector_map_;
  ...
  void onVectorMap(const autoware_lanelet2_msgs::msg::MapBin::ConstSharedPtr vector_map);
