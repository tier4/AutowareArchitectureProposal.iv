...
#ifndef EMERGENCY_HANDLER_UTIL_HEARTBEAT_CHECKER_HPP_
#define EMERGENCY_HANDLER_UTIL_HEARTBEAT_CHECKER_HPP_
...
{
public:
  HeaderlessHeartbeatChecker(rclcpp::Node & node, const std::string & topic_name, const double timeout)
  : clock_(node.get_clock()),
    timeout_(timeout)
  {
    using std::placeholders::_1;
    sub_heartbeat_ = rclcpp::create_subscription<HeartbeatMsg>(
