...
void GNSSPoser::callbackNavSatFix(const sensor_msgs::msg::NavSatFix::ConstSharedPtr nav_sat_fix_msg_ptr)
{
  ...
  geometry_msgs::msg::TransformStamped::SharedPtr TF_base_to_gnss_ptr(new geometry_msgs::msg::TransformStamped);
...
{
  return nav_sat_fix_msg.position_covariance_type > sensor_msgs::msg::NavSatFix::COVARIANCE_TYPE_UNKNOWN;
}
  ...
  const builtin_interfaces::msg::Time & stamp)
{
  ...
  try {
    *transform_stamped_ptr =
      tf2_buffer_.lookupTransform(target_frame, source_frame, tf2::TimePoint(
