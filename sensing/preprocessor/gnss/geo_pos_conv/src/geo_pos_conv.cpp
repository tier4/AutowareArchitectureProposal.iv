...
void geo_pos_conv::conv_llh2xyz(void)
{
  ...
  Pe = static_cast<double>(sqrt(2.0 * FW - pow(FW, 2)));
  Pet = static_cast<double>(sqrt(pow(Pe, 2) / (1.0 - pow(Pe, 2))));

  PA = static_cast<double>(1.0 + 3.0 / 4.0 * pow(Pe, 2) + 45.0 / 64.0 * pow(Pe, 4) +
  ...
  PB = static_cast<double>(
    3.0 / 4.0 * pow(Pe, 2) + 15.0 / 16.0 * pow(Pe, 4) + 525.0 / 512.0 * pow(Pe, 6) +
  ...
  PC = static_cast<double>(
    15.0 / 64.0 * pow(Pe, 4) + 105.0 / 256.0 * pow(Pe, 6) + 2205.0 / 4096.0 * pow(Pe, 8) +
  ...
  PD = static_cast<double>(
    35.0 / 512.0 * pow(Pe, 6) + 315.0 / 2048.0 * pow(Pe, 8) + 31185.0 / 131072.0 * pow(Pe, 10) +
    165165.0 / 524288.0 * pow(Pe, 12) + 45090045.0 / 117440512.0 * pow(Pe, 14) +
    209053845.0 / 469762048.0 * pow(Pe, 16));

  PE = static_cast<double>(
    315.0 / 16384.0 * pow(Pe, 8) + 3465.0 / 65536.0 * pow(Pe, 10) +
    99099.0 / 1048576.0 * pow(Pe, 12) + 4099095.0 / 29360128.0 * pow(Pe, 14) +
    348423075.0 / 1879048192.0 * pow(Pe, 16));

  PF = static_cast<double>(
    693.0 / 131072.0 * pow(Pe, 10) + 9009.0 / 524288.0 * pow(Pe, 12) +
    4099095.0 / 117440512.0 * pow(Pe, 14) + 26801775.0 / 469762048.0 * pow(Pe, 16));

  PG = static_cast<double>(
    3003.0 / 2097152.0 * pow(Pe, 12) + 315315.0 / 58720256.0 * pow(Pe, 14) +
    11486475.0 / 939524096.0 * pow(Pe, 16));

  PH =
    static_cast<double>(45045.0 / 117440512.0 * pow(Pe, 14) + 765765.0 / 469762048.0 * pow(Pe, 16));

  PI = static_cast<double>(765765.0 / 7516192768.0 * pow(Pe, 16));

  PB1 = static_cast<double>(AW * (1.0 - pow(Pe, 2)) * PA);
  PB2 = static_cast<double>(AW * (1.0 - pow(Pe, 2)) * PB / -2.0);
  PB3 = static_cast<double>(AW * (1.0 - pow(Pe, 2)) * PC / 4.0);
  PB4 = static_cast<double>(AW * (1.0 - pow(Pe, 2)) * PD / -6.0);
  PB5 = static_cast<double>(AW * (1.0 - pow(Pe, 2)) * PE / 8.0);
  PB6 = static_cast<double>(AW * (1.0 - pow(Pe, 2)) * PF / -10.0);
  PB7 = static_cast<double>(AW * (1.0 - pow(Pe, 2)) * PG / 12.0);
  PB8 = static_cast<double>(AW * (1.0 - pow(Pe, 2)) * PH / -14.0);
  PB9 = static_cast<double>(AW * (1.0 - pow(Pe, 2)) * PI / 16.0);

  PS = static_cast<double>(PB1 * m_lat + PB2 * sin(2.0 * m_lat) + PB3 * sin(4.0 * m_lat) +
    PB4 * sin(6.0 * m_lat) + PB5 * sin(8.0 * m_lat) + PB6 * sin(10.0 * m_lat) +
    PB7 * sin(12.0 * m_lat) + PB8 * sin(14.0 * m_lat) + PB9 * sin(16.0 * m_lat));

  PSo = static_cast<double>(PB1 * m_PLato + PB2 * sin(2.0 * m_PLato) + PB3 * sin(4.0 * m_PLato) +
  ...
  Pt = static_cast<double>(tan(m_lat));
  PW = static_cast<double>(sqrt(1.0 - pow(Pe, 2) * pow(sin(m_lat), 2)));
  PN = static_cast<double>(AW / PW);
  Pnn = static_cast<double>(sqrt(pow(Pet, 2) * pow(cos(m_lat), 2)));

  // cpp
  m_x =
    static_cast<double>(((PS - PSo) + (1.0 / 2.0) * PN *
    pow(
      cos(m_lat),
      2.0) * Pt *
    pow(
    ...
    pow(
      cos(m_lat),
      8) * Pt * (-1385.0 + 3111 * pow(Pt, 2) - 543 * pow(Pt, 4) + pow(Pt, 6)) * pow(PDL, 8)) *
    Pmo);

  m_y =
    static_cast<double>((PN * cos(m_lat) * PDL - 1.0 / 6.0 * PN *
    pow(
      cos(m_lat),
      3) *
    (-1 +
    ...
    pow(
      PDL,
      5) - 1.0 / 5040.0 * PN *
    pow(cos(m_lat), 7) * (-61.0 + 479.0 * pow(Pt, 2) - 179.0 * pow(Pt, 4) + pow(Pt, 6)) * pow(
      PDL,
      7)) *
    Pmo);
