...
private:
  ...
  rclcpp::Subscription<autoware_planning_msgs::msg::VelocityLimit>::SharedPtr sub_current_max_velocity_;
  ...
  void callbackCurrentMaxVelocity(const autoware_planning_msgs::msg::VelocityLimit::ConstSharedPtr msg_ptr);
