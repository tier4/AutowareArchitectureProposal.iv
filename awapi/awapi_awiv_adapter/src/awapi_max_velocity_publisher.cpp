...
{
AutowareIvMaxVelocityPublisher::AutowareIvMaxVelocityPublisher(const double default_max_velocity)
: nh_(), pnh_("~"), default_max_velocity_(default_max_velocity)
{
  // publisher
  pub_state_ = pnh_.advertise<std_msgs::Float32>("output/max_velocity", 1);
}
